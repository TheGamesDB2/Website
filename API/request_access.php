                ...
                <div class="card-body">
                    <form method="post" action="request_access.php">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Please provide details about your application and how you plan to use the API. Give as much detail as possible as we are being very stringent on who gains API access. Little to no detail will result in you not gaining access. It is appreciated if this is completed in English, doing so will speed up the approval process.</small>
                        </div>
                        <div class="form-group">
